...
if %errorlevel% neq 0 (
    ...
    echo Veuillez installer Python (cochez "Add Python to PATH") depuis: https://www.python.org/downloads/
    pause
    exit /b 1
)
...
if not exist "venv\Scripts\pip.exe" (
    echo [*] Creation d'un environnement propre...
    if exist "venv" (
...
echo [3/4] Installation des bibliotheques IA et Vision (YOLOv8 + OpenCV + FastAPI)...
