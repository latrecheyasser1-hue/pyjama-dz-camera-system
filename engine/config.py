...
RING_BUFFER_SECONDS = int(os.getenv("RING_BUFFER_SECONDS", "90"))
PRE_EVENT_BUFFER_SECONDS = int(os.getenv("PRE_EVENT_BUFFER_SECONDS", "20"))
POST_EVENT_BUFFER_SECONDS = int(os.getenv("POST_EVENT_BUFFER_SECONDS", "5"))
CAISSE_UNATTENDED_THRESHOLD_SECONDS = int(os.getenv("CAISSE_UNATTENDED_THRESHOLD_SECONDS", "30"))
EMPTY_COUNTER_THRESHOLD_SECONDS = int(os.getenv("EMPTY_COUNTER_THRESHOLD_SECONDS", "120")) # 2 minutes empty counter alert
